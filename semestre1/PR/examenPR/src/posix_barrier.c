...
void static wait_barrier( NB_PCS) {
	int valeur = 0;
	/** operation P **/
	sem_wait(sem_mutex);
...
//
//	/** creation sem et initialise nb_fils **/
//	if ((sem_mutex = sem_open(sem_nom1, O_CREAT | O_EXCL | O_RDWR, 0600,
//			nb_fils)) == SEM_FAILED) {
//		perror("sem_open");
//		exit(1);
//	}
//
//	/** creation sem2 et initialise 0 **/
